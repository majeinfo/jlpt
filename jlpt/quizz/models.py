...
class Verb(models.Model):
    ...
    cond_tara_neg = models.CharField(max_length=40, default='')
    cond_eba = models.CharField(max_length=40, default='')
    cond_eba_neg = models.CharField(max_length=40, default='')
    factitif = models.CharField(max_length=40, default='')
    potentiel = models.CharField(max_length=40, default='')
    potentiel_neg = models.CharField(max_length=40, default='')
